...
<script src="{{ asset('statics/gentelella/vendors/moment/min/moment.min.js') }}"></script>
<script src="{{ asset('statics/gentelella/vendors/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
